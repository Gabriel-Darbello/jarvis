...
## Comandos exatos para abrir aplicativos
- Firefox: DISPLAY=:0 firefox &
- Discord: DISPLAY=:0 discord &
- Terminal: DISPLAY=:0 gnome-terminal &
- VSCode: DISPLAY=:0 code &
- Prism Launcher: DISPLAY=:0 flatpak run org.prismlauncher.PrismLauncher &

## Regra obrigatória
- SEMPRE prefixe com DISPLAY=:0 antes de qualquer app gráfico
- SEMPRE use & no final
